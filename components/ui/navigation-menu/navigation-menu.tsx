      ...
      >
        <FocusTrap active={isExpanded}>
          <div className="relative">
            <div
              className={cn(
                'group flex min-h-[92px] items-center justify-between gap-1 overflow-y-visible bg-white dark:bg-gray-700 px-4 2xl:container sm:px-10 lg:gap-8 lg:px-12 2xl:mx-auto 2xl:px-0',
                className,
              )}
            >
              {children}
